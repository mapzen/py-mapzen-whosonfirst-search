...
setup(
    ...
    install_requires=[
        ...
        'mapzen.whosonfirst.elasticsearch>=0.02',
    ...
    dependency_links=[
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-elasticsearch/tarball/master#egg=mapzen.whosonfirst.elasticsearch-0.02'
        ],
    packages=packages,
    scripts=[
        'scripts/wof-es-id',
