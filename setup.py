...
setup(
    ...
    install_requires=[
        ...
        'mapzen.whosonfirst.elasticsearch>=0.031',
        'mapzen.whosonfirst.machinetag>=0.07',
    ...
    dependency_links=[
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-elasticsearch/tarball/master#egg=mapzen.whosonfirst.elasticsearch-0.031'
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-machinetag/tarball/master#egg=mapzen.whosonfirst.machinetag-0.07',
